...
mixin _$ConnectDetailState {
 ...
 PromptModel? get promptModel; Color get selectedColor; List<DrawingStroke> get allStrokes; ApiResultStatus get getPromptApiResultStatus; ApiResultStatus get saveDrawingApiResultStatus; DrawingStroke? get currentStroke;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ConnectDetailState&&(identical(other.currentPrompt, currentPrompt) || other.currentPrompt == currentPrompt)&&(identical(other.promptModel, promptModel) || other.promptModel == promptModel)&&(identical(other.selectedColor, selectedColor) || other.selectedColor == selectedColor)&&const DeepCollectionEquality().equals(other.allStrokes, allStrokes)&&(identical(other.getPromptApiResultStatus, getPromptApiResultStatus) || other.getPromptApiResultStatus == getPromptApiResultStatus)&&(identical(other.saveDrawingApiResultStatus, saveDrawingApiResultStatus) || other.saveDrawingApiResultStatus == saveDrawingApiResultStatus)&&(identical(other.currentStroke, currentStroke) || other.currentStroke == currentStroke));
}


@override
int get hashCode => Object.hash(runtimeType,currentPrompt,promptModel,selectedColor,const DeepCollectionEquality().hash(allStrokes),getPromptApiResultStatus,saveDrawingApiResultStatus,currentStroke);

@override
String toString() {
  return 'ConnectDetailState(currentPrompt: $currentPrompt, promptModel: $promptModel, selectedColor: $selectedColor, allStrokes: $allStrokes, getPromptApiResultStatus: $getPromptApiResultStatus, saveDrawingApiResultStatus: $saveDrawingApiResultStatus, currentStroke: $currentStroke)';
}
...
@useResult
$Res call({
 String currentPrompt, PromptModel? promptModel, Color selectedColor, List<DrawingStroke> allStrokes, ApiResultStatus getPromptApiResultStatus, ApiResultStatus saveDrawingApiResultStatus, DrawingStroke? currentStroke
});


$ApiResultStatusCopyWith<dynamic, $Res> get getPromptApiResultStatus;$ApiResultStatusCopyWith<dynamic, $Res> get saveDrawingApiResultStatus;
...
/// Create a copy of ConnectDetailState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentPrompt = null,Object? promptModel = freezed,Object? selectedColor = null,Object? allStrokes = null,Object? getPromptApiResultStatus = null,Object? saveDrawingApiResultStatus = null,Object? currentStroke = freezed,}) {
...
as ApiResultStatus,saveDrawingApiResultStatus: null == saveDrawingApiResultStatus ? _self.saveDrawingApiResultStatus : saveDrawingApiResultStatus // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$ApiResultStatusCopyWith<dynamic, $Res> get saveDrawingApiResultStatus {
  
  return $ApiResultStatusCopyWith<dynamic, $Res>(_self.saveDrawingApiResultStatus, (value) {
    return _then(_self.copyWith(saveDrawingApiResultStatus: value));
  });
}
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String currentPrompt,  PromptModel? promptModel,  Color selectedColor,  List<DrawingStroke> allStrokes,  ApiResultStatus getPromptApiResultStatus,  ApiResultStatus saveDrawingApiResultStatus,  DrawingStroke? currentStroke)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ConnectDetailState() when $default != null:
return $default(_that.currentPrompt,_that.promptModel,_that.selectedColor,_that.allStrokes,_that.getPromptApiResultStatus,_that.saveDrawingApiResultStatus,_that.currentStroke);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String currentPrompt,  PromptModel? promptModel,  Color selectedColor,  List<DrawingStroke> allStrokes,  ApiResultStatus getPromptApiResultStatus,  ApiResultStatus saveDrawingApiResultStatus,  DrawingStroke? currentStroke)  $default,) {final _that = this;
switch (_that) {
case _ConnectDetailState():
return $default(_that.currentPrompt,_that.promptModel,_that.selectedColor,_that.allStrokes,_that.getPromptApiResultStatus,_that.saveDrawingApiResultStatus,_that.currentStroke);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String currentPrompt,  PromptModel? promptModel,  Color selectedColor,  List<DrawingStroke> allStrokes,  ApiResultStatus getPromptApiResultStatus,  ApiResultStatus saveDrawingApiResultStatus,  DrawingStroke? currentStroke)?  $default,) {final _that = this;
switch (_that) {
case _ConnectDetailState() when $default != null:
return $default(_that.currentPrompt,_that.promptModel,_that.selectedColor,_that.allStrokes,_that.getPromptApiResultStatus,_that.saveDrawingApiResultStatus,_that.currentStroke);case _:
  return null;
...
class _ConnectDetailState implements ConnectDetailState {
  const _ConnectDetailState({this.currentPrompt = "Draw what makes you feel calm", this.promptModel, this.selectedColor = Colors.blue, final  List<DrawingStroke> allStrokes = const [], this.getPromptApiResultStatus = const ApiResultStatus.initial(), this.saveDrawingApiResultStatus = const ApiResultStatus.initial(), this.currentStroke}): _allStrokes = allStrokes;
...
@override@JsonKey() final  ApiResultStatus saveDrawingApiResultStatus;
...
@override
int get hashCode => Object.hash(runtimeType,currentPrompt,promptModel,selectedColor,const DeepCollectionEquality().hash(_allStrokes),getPromptApiResultStatus,saveDrawingApiResultStatus,currentStroke);
...
@override $ApiResultStatusCopyWith<dynamic, $Res> get getPromptApiResultStatus;@override $ApiResultStatusCopyWith<dynamic, $Res> get saveDrawingApiResultStatus;
...
/// Create a copy of ConnectDetailState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? currentPrompt = null,Object? promptModel = freezed,Object? selectedColor = null,Object? allStrokes = null,Object? getPromptApiResultStatus = null,Object? saveDrawingApiResultStatus = null,Object? currentStroke = freezed,}) {
